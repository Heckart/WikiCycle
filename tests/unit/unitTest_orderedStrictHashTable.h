...
#ifndef WIKICYCLE_TESTS_UNIT_UNITTEST_ORDEREDSTRICTHASHTABLE_H_
#define WIKICYCLE_TESTS_UNIT_UNITTEST_ORDEREDSTRICTHASHTABLE_H_
...
#endif // WIKICYCLE_TESTS_UNIT_UNITTEST_ORDEREDSTRICTHASHTABLE_H_
